...
/// Exercicio
    ...
    ///usuario M/m smp tem que mostrar em maiusculo.

/////Senha: --- minimo de 8 caracteres, tem que conter caracter especial e um número

////Cargo: ---- Estagio == 1 , trainne == 2 , Analista == 3 , jr == 4 , SN == 5, PL == 6, Lider Tecnico == 7 , CEO == 8 .

//////Após identificar o cargo do usúario voce vai mostrar um alert com as seguintes " ola usário, seu cargo é vamos te redirecionar para pagina desejada